...
public class AmigoCloudAvlModule extends AvlModule {
    private static final StringConfigValue feedUrl = new StringConfigValue(
    ...
    private static final LongConfigValue userId =
            new LongConfigValue(
    ...
    private static final LongConfigValue projectId = new LongConfigValue(
            "transitclock.avl.amigocloud.projectId", 661L,
            "The amigocloud ID of the agency that getting AVL data " + "from.");

    private static final LongConfigValue datasetId = new LongConfigValue(
    ...
    private static class MyAmigoWebsocketListener implements
        ...
        private final AmigoCloudAvlModule avlModule;
