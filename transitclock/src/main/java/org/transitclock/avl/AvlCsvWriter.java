...
public class AvlCsvWriter extends CsvWriterBase {
     ...
     *
     * @param fileName
     * @param timezoneStr For outputting time in proper timezone. If null then will
     ...
     * @param transformForChinaMap If true then will convert lat/lon so that can be displayed on
     *                             map of China.
     */
