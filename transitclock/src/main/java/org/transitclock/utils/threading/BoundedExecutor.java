...
public class BoundedExecutor {
     ...
     *
     * @param exec                          The executor. Recommend using Executors.newFixedThreadPool()
     *                                      to get a fixed thread pool.
     * @param allowableNumberBeforeBlocking How many items that can be queued before execute() will block
