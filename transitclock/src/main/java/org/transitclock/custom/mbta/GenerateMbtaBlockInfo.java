...
public class GenerateMbtaBlockInfo {
    ...
    private static final String timeZoneStr = "America/New_York";

    private static final Time time = new Time(timeZoneStr);

    // Keyed on tripShortName, value is blockId
    private static final Map<String, String> tripToBlockMap =
            new HashMap<String, String>();

    // For when a trip was assigned to multiple blocks.
    // Keyed on the trip Id. Contains list of blocks associated
    // with the trip.
    private static final Map<String, Set<String>> mismatchedAssignments =
            new HashMap<String, Set<String>>();

    // Keyed on trip ID
    private static final Map<String, String> tripIdToTripShortNameMap =
            new HashMap<String, String>();

    // Keyed on trip short name. Value is the corresponding GtfsTrip
    private static final Map<String, GtfsTrip> gtfsTripsMap =
            new HashMap<String, GtfsTrip>();

    // Keyed on trip short name. Values are times in seconds into day
    private static final Map<String, Integer> tripStartTimeMap =
            new HashMap<String, Integer>();
    private static final Map<String, Integer> tripEndTimeMap =
            new HashMap<String, Integer>();
    ...
    private static final Map<String, String> tripToModifiedServiceIdMap =
            new HashMap<String, String>();
        ...
        for (String vehicleId : reportsByVehicle.keySet()) {
            ...
            for (AvlReport avlReport : avlReportsForVehicle) {
                ...
                if (start != null) {
                    ...
                    String s = earlinessOfAssignment + "s";
                    while (s.length() < 5)
                        s += " ";
    ...
    /**
     * @param args args[0] is the date to run program for, args[1] is number of
