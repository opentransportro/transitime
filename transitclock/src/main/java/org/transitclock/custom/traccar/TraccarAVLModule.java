...
public class TraccarAVLModule extends PollUrlAvlModule {
    ...
    private static final StringConfigValue traccarEmail = new StringConfigValue("transitclock.avl.traccar.email", "admin",
            "This is the username for the traccar server api.");
    private static final StringConfigValue traccarPassword = new StringConfigValue("transitclock.avl.traccar.password",
            "admin", "This is the password for the traccar server api");
    private static final StringConfigValue traccarBaseUrl = new StringConfigValue("transitclock.avl.traccar.baseurl",
            "http://127.0.0.1:8082/api", "This is the url for the traccar server api.");
    private static final StringConfigValue traccarSource = new StringConfigValue("transitclock.avl.traccar.source",
