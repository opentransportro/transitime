...
public class BullrunnerPlaybackModule extends PollUrlAvlModule {
    ...
    private static final StringConfigValue bullrunnerbasePlaybackUrl =
    ...
    private static final boolean shouldProcessAvl = true;
