...
public class GtfsData {
    ...
    private static final StringConfigValue routeIdFilterRegEx = new StringConfigValue(
    ...
    private static final StringConfigValue tripIdFilterRegEx = new StringConfigValue(
    ...
    private static final IntegerConfigValue stopCodeBaseValue =
    ...
    private static final DoubleConfigValue minDistanceBetweenStopsToDisambiguateHeadsigns =
    ...
    private static final StringConfigValue outputPathsAndStopsForGraphingRouteIds =
    ...
    // parent ID.
    private final Map<String, String> properRouteIdMap =
