...
public class StopPathProcessor {
     ...
     * @param stopsMap
     * @param tripPatterns
     * @param offsetDistance                    How much to the right the stopPaths should be offset. If
     ...
     * @param Indicates                         that shouldn't use the shape before the first stop of the
     ...
     * stopPaths.
     *
     * @param gtfsShapes List of GtfsShape objects that represent the original path for
     *                   the shape.
     * @return
     */
     ...
     *
     * @param shapeLocs             List of Locations that represent the shapes that matching the
     *                              stops to.
     * @param stopIdsForTripPattern List of IDs of the stops that need to match to shapes.
     * @param tripPattern           so can get routeId, tripPatternId, and shapeId when creating
