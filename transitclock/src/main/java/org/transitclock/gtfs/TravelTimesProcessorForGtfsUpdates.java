...
public class TravelTimesProcessorForGtfsUpdates {
     ...
     * trip.
     *
     * @param travelTimesFromDbMap Keyed on tripPatternId, contains list of TravelTimesForTrip
     ...
     * @param ttForTripFromDbList  list of travel times from the db for the trip pattern. Can be
     *                             null.
     * @param travelTimesFromDbMap so can add newly created schedule based travel times so can
     ...
     *
     * @param trip            which trip trying to get travel times for
     * @param ttForTripFromDb schedule based travel times from db that checking to see if
