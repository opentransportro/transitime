...
public class TimeoutHandlerModule extends Module {
    ...
    private static final IntegerConfigValue pollingRateSecs =
    ...
    private static final IntegerConfigValue allowableNoAvlSecs =
            new IntegerConfigValue(
    ...
    private static final IntegerConfigValue allowableNoAvlAfterSchedDepartSecs =
            new IntegerConfigValue(
    ...
    private static final BooleanConfigValue removeTimedOutVehiclesFromVehicleDataCache =
    ...
    private final HashMap<String, AvlReport> avlReportsMap =
