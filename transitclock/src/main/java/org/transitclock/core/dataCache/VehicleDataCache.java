...
public class VehicleDataCache {
    ...
    // Keyed by vehicle ID
    private final Map<String, IpcVehicleComplete> vehiclesMap =
    ...
    private final Map<String, List<String>> vehicleIdsByBlockMap =
    ...
    private final ConcurrentHashMap<String, VehicleConfig> vehicleConfigsMap =
            new ConcurrentHashMap<String, VehicleConfig>();
    // So can quickly look up vehicle config using tracker ID
    private final Map<String, VehicleConfig> vehicleConfigByTrackerIdMap =
     ...
     *
     * @param originalVehicle For getting the previous block ID for the vehicle. Can be null
