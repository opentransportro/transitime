...
public class FrequencyBasedHistoricalAverageCache {
    ...
    private static final IntegerConfigValue minTravelTimeFilterValue = new IntegerConfigValue(
    ...
    private static final IntegerConfigValue maxTravelTimeFilterValue = new IntegerConfigValue(
    ...
    private static final IntegerConfigValue minDwellTimeFilterValue = new IntegerConfigValue(
    ...
    private static final IntegerConfigValue maxDwellTimeFilterValue = new IntegerConfigValue(
    ...
    private static final IntegerConfigValue cacheIncrementsForFrequencyService =
