...
public class ExponentialBiasAdjuster implements BiasAdjuster {
    private static final DoubleConfigValue baseNumber = new DoubleConfigValue(
    ...
    private static final DoubleConfigValue multiple = new DoubleConfigValue(
     ...
     *
     */
    private static final DoubleConfigValue constant = new DoubleConfigValue(
            "org.transitclock.core.predictiongenerator.bias.exponential.c", -0.5,
            "Constant. y=a(b^x)+c.");
    private static final IntegerConfigValue updown = new IntegerConfigValue(
