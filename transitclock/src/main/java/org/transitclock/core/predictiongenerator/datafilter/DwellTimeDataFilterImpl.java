...
public class DwellTimeDataFilterImpl implements DwellTimeDataFilter {
    private static final LongConfigValue maxDwellTimeAllowedInModel = new LongConfigValue(
    ...
    private static final IntegerConfigValue minSceheduleAdherence = new IntegerConfigValue(
            "transitclock.prediction.dwell.minSceheduleAdherence", 10 * Time.SEC_PER_MIN,
    ...
    private static final IntegerConfigValue maxSceheduleAdherence = new IntegerConfigValue(
            "transitclock.prediction.dwell.maxSceheduleAdherence", 10 * Time.SEC_PER_MIN,
            "If schedule adherence of vehicle is outside this then not considerd in dwell algorithm.");
