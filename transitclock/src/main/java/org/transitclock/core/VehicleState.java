...
public class VehicleState {
    ...
    private final LinkedList<TemporalMatch> temporalMatchHistory =
            new LinkedList<TemporalMatch>();
    // First is most recent
    private final LinkedList<AvlReport> avlReportHistory =
     ...
     *
     * @param newBlock         The current block assignment for the vehicle. Set to null if
     *                         vehicle not assigned.
     * @param assignmentMethod How vehicle was assigned (AVL feed, auto assigner, etc). Set
     *                         to null if vehicle not assigned.
     * @param assignmentId     Can be blockId, tripId, or tripShortName. Depends on type of
