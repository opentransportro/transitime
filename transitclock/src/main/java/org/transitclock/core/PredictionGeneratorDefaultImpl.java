...
public class PredictionGeneratorDefaultImpl implements PredictionGenerator, PredictionComponentElementsGenerator {
    ...
    private static final IntegerConfigValue maxPredictionsTimeSecs =
            new IntegerConfigValue("transitclock.core.maxPredictionsTimeSecs",
                    45 * Time.SEC_PER_MIN,
                    "How far forward into the future should generate " +
                            "predictions for.");
    private static final LongConfigValue generateHoldingTimeWhenPredictionWithin =
    ...
    private static final BooleanConfigValue useArrivalPredictionsForNormalStops =
    ...
    private static final IntegerConfigValue maxLateCutoffPredsForNextTripsSecs =
            new IntegerConfigValue("transitclock.core.maxLateCutoffPredsForNextTripsSecs",
                    ...
                    "If a vehicle is further behind schedule than this amount "
                            ...
                            + "vehicle being late.");
    private static final BooleanConfigValue useExactSchedTimeForWaitStops =
    ...
    private static final BooleanConfigValue useHoldingTimeInPrediction =
     ...
     * @param useArrivalTimes       For when not at end of trip or at a waitStop we have the
     ...
     * @param affectedByWaitStop    to indicate if prediction is not as accurate because it
    ...
    public List<IpcPrediction> generate(VehicleState vehicleState) {
        ...
        boolean lateSoMarkSubsequentTripsAsUncertain = lateness != null && lateness.isLaterThan(maxLateCutoffPredsForNextTripsSecs
                .getValue());
