...
public class ConfigFileReader {
     ...
     *
     * @param nodeList The data from the XML file that was processed by the DOM XML
     *                 processor
     * @param names    For keeping track of the full hierarchical parameter name such
...
//					}
     ...
     *
     * @param fileName Name of the config file. If null then default values will be
