...
public class ConvertGtfsRtToCsvFile {
    ...
    private static final StringListConfigValue gtfsRealtimeURIs =
    ...
    private static final StringConfigValue csvFileOutputDir =
    ...
    private static final StringConfigValue timeZoneStr =
            new StringConfigValue("transitclock.avl.timeZoneStr",
                    "",
                    "The timezone for the agency. In the form " +
                            "\"America/New_York\"");
    private static final BooleanConfigValue offsetForMapOfChina =
