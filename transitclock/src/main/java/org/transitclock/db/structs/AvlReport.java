...
public class AvlReport implements Serializable {
     ...
     * @param speed     Speed of vehicle in m/s. Should be set to Float.NaN if speed
     *                  not available
     * @param heading   Heading of vehicle in degrees clockwise from north. Should be
     ...
     * @param heading   Heading of vehicle in degrees clockwise from north. Should be
     *                  set to Float.NaN if speed not available
     * @param source    Text describing the source of the report. Can only be
    ...
    /**
     * @param vehicleId ID of the vehicle
     * @param time      Epoch time in msec of GPS report (not when processed) For when
     *                  speed and heading are not valid. They are set to Float.NaN .
     *                  Since not yet being processed timeProcessed is set to null.
     * @param vehicleId
     * @param time      GPS time, in number of milliseconds since the standard base
     ...
     * @param passengerCount    Optional value. Set to the number of passengers on vehicles.
     *                          Set to null if not available.
     * @param passengerFullness Optional Value. Fractional fullness of vehicle. 0.0=empty,
     ...
     * @param beginTime
     * @param endTime
     * @param vehicleId Optional. If not null then will only return results for that
     *                  vehicle
     * @param clause    Optional. If not null then the clause, such as "ORDER BY time"
