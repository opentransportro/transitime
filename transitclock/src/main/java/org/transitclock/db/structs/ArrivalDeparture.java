...
public class ArrivalDeparture implements Lifecycle, Serializable {
     ...
     * method.
     *
     * @param dbName             Name of the database to retrieve data from. If set to null
     *                           then will use db name configured by Java property
     *                           transitclock.db.dbName
     * @param beginTime
     * @param endTime
     * @param sqlClause          The clause is added to the SQL for retrieving the
     *                           arrival/departures. Useful for ordering the results. Can be
     *                           null.
     * @param firstResult        For when reading in batch of data at a time.
     * @param maxResults         For when reading in batch of data at a time. If set to 0 then
     *                           will read in all data at once.
     * @param arrivalOrDeparture Enumeration specifying whether to read in just arrivals or
