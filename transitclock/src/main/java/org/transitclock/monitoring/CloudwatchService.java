...
public class CloudwatchService {
    ...
    private final Map<String, MetricDefinition> metricMap = new ConcurrentHashMap<>();
    private final Integer _batchSize = 1000;
    private final ArrayBlockingQueue<MetricScalar> individualMetricsQueue = new ArrayBlockingQueue<MetricScalar>(
            100000);
