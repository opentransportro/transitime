 ...
 * he number of current calls to a project are limited so that the
 * erver cannot be overwhelmed. This prevents problems due to denial of
 * ervice attack or the project doing stop the world garbage collecting
 * nd therefore being unavailable for a while.
 * p>
 * o create a RMI object do the following:
 * <ul>
