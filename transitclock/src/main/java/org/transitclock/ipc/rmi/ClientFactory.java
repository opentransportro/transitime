...
public class ClientFactory<T extends Remote> {
    ...
    private static final IntegerConfigValue timeoutSec = new IntegerConfigValue(
    ...
    private static final StringConfigValue debugRmiServerHost = new StringConfigValue(
     ...
     * @param clazz    Because this is a static method the only way to get the class
     ...
     * @param updateHostName Indicates whether should update host name instead of just
