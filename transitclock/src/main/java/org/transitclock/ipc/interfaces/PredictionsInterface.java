...
public interface PredictionsInterface extends Remote {
     ...
     */
    List<IpcPredictionsForRouteStopDest> get(
     ...
     *
     * @param routeStops         List of route/stops to return predictions for. Uses route
     ...
     */
    HashMap<CanceledTripKey, IpcCanceledTrip> getAllCanceledTrips() throws RemoteException;
     ...
     * @throws RemoteException
     */
    List<IpcPredictionsForRouteStopDest> get(Location loc,
     ...
     * @throws RemoteException
     */
    List<IpcPredictionsForRouteStopDest> getAllPredictions(
