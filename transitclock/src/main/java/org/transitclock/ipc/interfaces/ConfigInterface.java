...
public interface ConfigInterface extends Remote {
     ...
     *
     * @param routeIdOrShortName Specifies which route to provide data for. routeShortName is
     *                           often used instead of routeId since routeIds unfortunately
     *                           often change when there is a schedule change.
     * @param directionId        optional. If want UI to highlight the remaining stops and
     ...
     * @param stopId             optional. If want UI to highlight the remaining stops and
     ...
     * @param tripPatternId      optional. If want UI to highlight the remaining stops and
     ...
     * @throws RemoteException
     */
    IpcRoute getRoute(String routeIdOrShortName, String directionId,
    ...
    List<String> getServiceIdsForDay(Long currentTimeMillis) throws RemoteException;
     ...
     * @throws RemoteException
     */
    boolean getServiceIdSuffix() throws RemoteException;
