...
public class IpcPredictionsForRouteStopDest implements Serializable {
     ...
     * @param trip
     * @param stopId
     * @param distanceToStop How far stop is away from user. If predictions are not
     ...
     *
     * @param currentTime Should use PredictionDataCache.systemTime.get() so that works
