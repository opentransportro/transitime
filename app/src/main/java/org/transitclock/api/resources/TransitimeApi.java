...
@OpenAPIDefinition(
        info = @Info(
                ...
                version = "2.0.0",
                contact = @Contact(name = "Vlad Vesa", email = "vlad.vesa@outlook.com"),
        ...
        tags = {
                @Tag(name = "cache", description = "Get detailed information about active caches."),
                @Tag(name = "vehicle", description = "Get detailed information about vehicles."),
                @Tag(name = "route", description = "Get detailed information about routes."),
                @Tag(name = "trip", description = "Get detailed information about trips."),
                @Tag(name = "block", description = "Get detailed information about blocks."),
                @Tag(name = "agency", description = "Get detailed information about agencies."),
                @Tag(name = "stop", description = "Get detailed information about stops."),
                @Tag(name = "calendar", description = "Get detailed information about services."),
                @Tag(name = "command", description = "Perform commands that are changing the system state."),
                @Tag(name = "GTFS", description = "Export data in GTFS Realtime format.", externalDocs = @ExternalDocumentation(description = "google gtfs rt developer guide", url = "https://developers.google.com/transit/gtfs-realtime")),
                @Tag(name = "SIRI", description = "Export data in SIRI format.", externalDocs = @ExternalDocumentation(description = "european siri standard", url = "https://www.transmodel-cen.eu/siri-standard/")),
        })
...
public class TransitimeApi {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiVehicles.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiVehicleToBlockConfigs.class))
            })
    })
    ...
    public Response scheduleAdhReport(
            ...
            @Parameter(description = "Begin time(HH:MM)") @QueryParam(value = "beginTime") String beginTime,
            @Parameter(description = "End time(HH:MM)") @QueryParam(value = "endTime") String endTime,
            @Parameter(description = "Allowable early in minutes (default 1.0)") @QueryParam(value = "allowableEarly")
            String allowableEarly,
            @Parameter(description = "Allowable late in minutes (default 4.0") @QueryParam(value = "allowableLate")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiIds.class))
            })
    })
    @GET
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = Location.class))
            })
    })
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiVehiclesDetails.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiVehicleConfigs.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiPredictions.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiRoutes.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiRoutesDetails.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiDirections.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiBlock.class))
            })
    })
     ...
     * @throws WebApplicationException
     */
    @Path("/command/blocks-terse")
    @GET
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(
            summary = "Retrieves configuration data for the specified block ID.",
            description = "Retrieves configuration data for the specified block ID. It does not include"
                    + " trip patterns.Every trip is associated with a block.",
            tags = {"block"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiBlockTerse.class))
            })
    })
    ...
    @Operation(
            summary = "Retrieves configuration data for the specified block ID",
            description = "Retrieves configuration data for the specified block ID. Includes all sub-data"
                    + " such as trips and trip.Every trip is associated with a block.",
            tags = {"block"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiBlocks.class))
            })
    })
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(
            summary = "Retrieves a list of all blockId for the specified service ID",
            description = "Retrieves a list of all blockId for the specified service ID."
                    + "Every trip is associated with a block.",
            tags = {"block"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
    ...
    @Operation(
            ...
            description = "Retrieves a list of active blocks. Optionally can be filered accorditn to"
                    + " routesIdOrShortNames params.Every trip is associated with a block.",
            tags = {"block"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiActiveBlocks.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiActiveBlocksRoutes.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiAdherenceSummary.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiTrip.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiTripWithTravelTimes.class))
            })
    })
    public Response getTripWithTravelTimes(
            @BeanParam StandardParameters stdParameters,
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiTripPatterns.class))
            })
    })
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(
            summary = "Retrieves schedule for the specified route.",
            description = "Retrieves schedule for the specified route.  The data is output such that the"
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiSchedulesVertStops.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiScheduleHorizStops.class))
            })
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiCalendars.class))
            })
    })
     ...
     * @throws WebApplicationException
     */
    @Path("/command/all-service-ids")
    @GET
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(
            summary = "Retrieves all service id.",
            description = "Retrieves all service id.",
            tags = {"calendar"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Ok", content = {
                    @Content(schema = @Schema(implementation = ApiIds.class))
     ...
     * @throws WebApplicationException
     */
    @Path("/command/current-service-ids")
    @GET
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(
