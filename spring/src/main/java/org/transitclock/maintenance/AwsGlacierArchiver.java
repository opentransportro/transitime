...
public class AwsGlacierArchiver implements ArchiverInterface {
    ...
    private void addToArchiveLog(String description, String archiveId) {
        ...
        logger.info(
                "Logging for vaultName \"{}\" the description \"{}\" and " + "archiveId \"{}\" to logfile \"{}\"",
                vaultName,
                description,
                archiveId,
                logFile);
        try {
            ...
            logger.error(
                    "Exception occurred when adding description=\"{}\" " + "to vaultName=\"{}\" for logFile=\"{}\"",
                    description,
                    vaultName,
                    logFile,
                    e);
    ...
    public String upload(String fileName, String description) {
        logger.info(
                "Uploading to Amazon AWS Glacier vaultName=\"{}\" the " + "file=\"{}\" with description=\"{}\"",
                vaultName,
                fileName,
                description);
        ...
        if (archiveId != null) {
            ...
            logger.error(
                    "Error occurred uploading to vaultName=\"{}\" the " + "fileName=\"{}\" with description=\"{}\"",
                    vaultName,
                    fileName,
                    description);
        }
