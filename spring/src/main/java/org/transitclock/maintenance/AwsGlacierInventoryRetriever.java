...
public class AwsGlacierInventoryRetriever {
    ...
    public void getVaultInventory(String vaultName, String outputFileName) {
        logger.info(
                "Getting vault inventory for vaultName={} and storing " + "it into file {}", vaultName, outputFileName);
        ...
        try {
            ...
            if (!success) {
                logger.error("Job did not complete successfully for " + "vaultName={} jobId=", vaultName, jobId);
                return;
            }
            ...
            logger.error("Exception getting vault inventory for vaultName={}" + "jobId=", vaultName, jobId);
        }
    }
     ...
     * directory.
     *
     * @param args args[0] specifies vaultName. args[1] specifies the directory where the output
    ...
    public static void main(String[] args) {
        ...
        AwsGlacierInventoryRetriever inventoryRetriever = new AwsGlacierInventoryRetriever(AwsGlacier.OREGON_REGION);
