...
public class SchemaGenerator {
    ...
    /**
     * Gets rid of the unwanted drop table commands. These aren't needed because the resulting
     * script is intended only for creating a database, not for deleting all the data and recreating
     * the tables.
     *
     ...
     * be exported such as "org.transitclock.core.domain". args[1] is optional output directory where
     ...
     *
     * <p>The resulting files have the name "ddl_" plus dialect name such as mysql or oracle plus
     * the first two components of the package name such as org_transitclock.
     */
