...
public class IpcSchedule implements Serializable {
     ...
     * times for the same stops for a trip. Basically need to go through stops for the trips and
     * find the first common stop and compare times for it.
     */
     ...
     * should put weekday before Saturday before Sunday. Also sorts by direction ID when service
     * class is the same. And if number of trips is the same then tries to put Sunday last by
     * looking at the serviceId.
     *
            ...
            public int compare(IpcSchedule o1, IpcSchedule o2) {
                if (o1.getServiceId().equals(o2.getServiceId())) {
                    ...
                    if (o1.getIpcSchedTrips().size() < o2.getIpcSchedTrips().size()) return 1;
                            ...
                            > o2.getIpcSchedTrips().size()) return -1;
                    else {
