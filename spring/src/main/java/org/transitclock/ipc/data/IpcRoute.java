...
public class IpcRoute extends IpcRouteSummary {
    ...
    /**
     * Returns trip pattern specified by tripPatternId or stopId. If tripPatternId is null but
     ...
     * specified then the ones remaining for the specified trip are considered to be UI stops that
