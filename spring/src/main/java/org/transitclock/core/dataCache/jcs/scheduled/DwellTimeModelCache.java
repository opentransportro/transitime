...
public class DwellTimeModelCache implements org.transitclock.core.dataCache.DwellTimeModelCacheInterface {
    ...
    private static LongConfigValue minHeadwayAllowedInModel = new LongConfigValue(
                        ...
                        if (arrival != null && previousArrival != null) {
                            ...
                            if (departure.getScheduleAdherence() != null
                                    && departure
                                            ...
                                            .isWithinBounds(
                                                    minSceheduleAdherence.getValue(),
                                                    maxSceheduleAdherence.getValue())) {

                                // Arrival schedule adherence appears not to be set alot. So only
                                ...
                                if (previousArrival.getScheduledAdherence() == null
                                    ...
                                    logger.info("Schedule adherence outside allowable range. "
