...
public class TripDataHistoryCache implements TripDataHistoryCacheInterface {
    ...
    public List<IpcArrivalDeparture> getTripHistory(TripKey tripKey) {
        ...
        int time = FrequencyBasedHistoricalAverageCache.round(
                tripKey.getStartTime(), FrequencyBasedHistoricalAverageCache.getCacheIncrementsForFrequencyService());
    ...
    /* (non-Javadoc)
     * @see org.transitclock.core.dataCache.ehcache.test#findPreviousArrivalEvent(java.util.List, org.transitclock.core.domain.ArrivalDeparture)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.transitclock.core.dataCache.ehcache.test#findPreviousDepartureEvent(java.util.List, org.transitclock.core.domain.ArrivalDeparture)
     */
    @Override
