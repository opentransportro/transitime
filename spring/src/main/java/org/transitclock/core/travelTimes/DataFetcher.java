...
import org.transitclock.core.domain.ActiveRevisions;
...
public class DataFetcher {
    ...
    /**
     * Takes the date and returns the day into the year. Useful for keeping track of trip data one
     * day at a time.
     *
     * @param date
     * @return
    ...
    /**
     * Special MapKey class so that can make sure using the proper key for the associated maps in
     * this class.
     */
    ...
    /**
     * Returns a key for use in a map. They key consists of the serviceId, an optional day of the
     * week if the day specified by the date parameter matches the calendar specified by the service
     * ID, the tripId, and the vehicleId. This way can separate out data for special days like
     * Fridays for a weekday service class.
     *
     * @param serviceId
     * @param date Used to determine the day of week to be used in conjunction with the service
     *     class.
     * @param tripId
     * @param vehicleId
     * @return
