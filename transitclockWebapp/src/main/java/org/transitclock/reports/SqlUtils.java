...
public class SqlUtils {
     ...
     *
     * @param request        Http request containing parameters for the query
     * @param tableAliasName for when joins are used such that a table has an alias such as
     ...
     * @param maxNumDays     maximum number of days for query. Request parameter numDays is
