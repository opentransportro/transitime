...
public class LastDepartureHeadwayGenerator implements HeadwayGenerator {
    ...
    public LastDepartureHeadwayGenerator(VehicleDataCache vehicleDataCache, VehicleStateManager vehicleStateManager, StopArrivalDepartureCacheInterface stopArrivalDepartureCacheInterface) {
