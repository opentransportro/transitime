...
public class Indices implements Serializable {
     ...
     *
     * @param epochTime For no schedule assignments. So can determine if should loop
     *                  back to same trip.
     ...
     *
     * @param timeOfDaySecs The current time of day, so that can return the proper trip
     ...
     * of day. Assumes that there is only single trip defined for a route/loop.
     *
     * @param time The current time so can determine time of day and return the
     ...
     *
     * @param epochTime For when dealing with noSchedule assignment. Specifies current
     *                  time of day
