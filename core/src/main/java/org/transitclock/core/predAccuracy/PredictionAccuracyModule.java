...
public class PredictionAccuracyModule extends Module {
    ...
    private static final ConcurrentHashMap<PredictionKey, List<PredAccuracyPrediction>> predictionMap =
     ...
     *
     * @param pred
     * @param arrivalDeparture The corresponding arrival/departure information. Can be null
