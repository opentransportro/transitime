...
public class NextBusPredictionAccuracyModule extends PredictionAccuracyModule {
    ...
    private static final Logger logger = LoggerFactory.getLogger(NextBusPredictionAccuracyModule.class);

    /********************** Config Params **************************/
    private static final StringConfigValue externalPredictionApiUrl = new StringConfigValue(
    ...
    private static final StringConfigValue nextBusAgencyIdForApi =
            new StringConfigValue("transitclock.predAccuracy.nextBusAgencyIdForApi", null, "Name of agency for API");
    ...
    private String getUrl(RouteAndStops routeAndStops) {
        ...
        String fullUrl =
                getExternalPredictionApiUrl() + "command=predictionsForMultiStops" + "&a=" + getNextBusAgencyIdForApi();
        ...
        if (routeIdForNextBusApi == null || routeIdForNextBusApi.isEmpty()) routeIdForNextBusApi = route.getId();
        ...
        for (Element predictionsForStop : allPredictions) {
            ...
            for (Element direction : directions) {
                ...
                for (Element prediction : predictions) {
                    ...
                    boolean affectedByWaitStop = "true".equals(prediction.getAttributeValue("affectedByLayover"));
