...
public class PredAccuracyPrediction {
     ...
     *
     * @param routeId
     * @param directionId        Might not always be available from prediction API so can be
     *                           set to null.
     * @param stopId
     * @param tripId             Might not always be available from prediction API so can be
     *                           set to null.
     * @param vehicleId
     * @param predictedTime
     ...
     * @param source             Description of the feed, especially useful if have couple of
