...
public class BlocksInfo {
    ...
    private static final IntegerConfigValue blockactiveForTimeBeforeSecs = new IntegerConfigValue("transitclock.core.blockactiveForTimeBeforeSecs", new Integer(0), "Now many seconds before the start of a block it will be considered active.");
    private static final IntegerConfigValue blockactiveForTimeAfterSecs = new IntegerConfigValue("transitclock.core.blockactiveForTimeAfterSecs", new Integer(-1), "Now many seconds after the end of a block it will be considered active.");
     ...
     *
     * @param beforeStartTimeSecs Specifies in seconds how much before the block start time that
     ...
     * routes.
     *
     * @param routeIds                    Collection of routes IDs that want blocks for. Use null to
     *                                    indicate all routes.
     * @param blockIdsToIgnore            Won't do the expensive lookup of the blocks in this set. This
