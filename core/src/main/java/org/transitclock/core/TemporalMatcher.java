...
public class TemporalMatcher {
     ...
     * @param date
     * @param spatialMatch
     * @param isFirstSpatialMatch Set to true if this is the first of the spatial matches. This
     ...
     * @param spatialMatches So can get current spatial match being investigated and
