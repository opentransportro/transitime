...
public class AvlProcessor {
    ...
    private static final DoubleConfigValue terminalDistanceForRouteMatching =
    ...
    private static final IntegerConfigValue allowableBadAssignments =
    ...
    private static final BooleanConfigValue emailMessagesWhenAssignmentGrabImproper =
            new BooleanConfigValue(
                    ...
                    "When one vehicle gets assigned by AVL feed but another "
                            ...
                            + "e-mails.");
    private static final DoubleConfigValue maxDistanceForAssignmentGrab =
            new DoubleConfigValue(
    ...
    private static final DoubleConfigValue maxMatchDistanceFromAVLRecord =
            new DoubleConfigValue(
                    "transitclock.core.maxMatchDistanceFromAVLRecord",
                    500.0,
                    "For logging distance between spatial match and actual AVL assignment ");
    private static final BooleanConfigValue ignoreInactiveBlocks =
            new BooleanConfigValue(
    ...
    private final Map<String, Long> problemGrabbingAssignmentMap =
     ...
     * @param vehicleEvent     A short description from VehicleEvent class for labeling the
     *                         event.
     */
     ...
     *
     * @param vehicleState For providing the temporal match and the AVL history. It is
     ...
     *
     * @param bestMatch                     The TemporalMatch that the vehicle was matched to. If set then
     ...
     * @param assignmentType                A string for logging and such indicating whether assignment
     ...
     *
     * @param vehicleState provides current AvlReport plus is updated by this method with
     *                     the new state.
     ...
     * @param recursiveCall Set to true if this method is calling itself. Used to make
