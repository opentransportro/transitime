...
public class TravelTimeDataFilterImpl implements TravelTimeDataFilter {
    ...
    private static final LongConfigValue maxTravelTimeAllowedInModel = new LongConfigValue(
    ...
    private static final LongConfigValue minTravelTimeAllowedInModel = new LongConfigValue(
    ...
    private static final IntegerConfigValue minSceheduleAdherence = new IntegerConfigValue(
            "transitclock.prediction.travel.minSceheduleAdherence", 10 * Time.SEC_PER_MIN,
            "If schedule adherence of vehicle is outside this then not considerd in travel time algorithm.");
    private static final IntegerConfigValue maxSceheduleAdherence = new IntegerConfigValue(
            "transitclock.prediction.travel.maxSceheduleAdherence", 10 * Time.SEC_PER_MIN,
            "If schedule adherence of vehicle is outside this then not considerd in travel time algorithm.");
