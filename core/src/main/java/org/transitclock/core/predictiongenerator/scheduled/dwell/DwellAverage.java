...
public class DwellAverage implements DwellModel, Serializable {
    ...
    private static final IntegerConfigValue samplesize = new IntegerConfigValue("transitclock.prediction.dwell.average.samplesize", 5, "Max number of samples to keep for mean calculation.");
    private static final DoubleConfigValue fractionLimitForStopTimes = new DoubleConfigValue("transitclock.prediction.dwell.average.fractionlimit", 0.7, "For when determining stop times. Throws out outliers if they are less than 0.7 or greater than 1/0.7 of the average.");
