...
public class TravelTimesProcessor {
    ...
    // of the average.
    private static final DoubleConfigValue fractionLimitForStopTimes = new DoubleConfigValue("transitclock.traveltimes.fractionLimitForStopTimes",
            0.7,
            "For when determining stop times. Throws out outliers.");
    // For when determining travel times for segments. Throws out
    // outliers if they are less than 0.7 or greater than 1/0.7
    // of the average.
    private static final DoubleConfigValue fractionLimitForTravelTimes = new DoubleConfigValue("transitclock.traveltimes.fractionLimitForTravelTimes",
            0.7,
            "For when determining travel times. Throws out outliers.");
    private static final BooleanConfigValue resetEarlyTerminalDepartures =
    ...
    private static final DoubleConfigValue maxTravelTimeSegmentLength =
    ...
    private static final DoubleConfigValue minSegmentSpeedMps =
            new DoubleConfigValue("transitclock.traveltimes.minSegmentSpeedMps",
                    ...
                    "If a travel time segment is determined to have a lower "
                            ...
                            + "bad data.");
    private static final DoubleConfigValue maxSegmentSpeedMps =
     ...
     *
     * @param historicTravelTimes List of List of times where outer List is by single trip and
     *                            inner List is travel time segment.
     * @param trip                Contains config info for the trip that the data is for. Used
     *                            to determine if the historic data for the trip has the proper
     *                            number of travel time segments.
     * @param stopPathIndex       Used to determine if the historic data for the trip has the
     ...
     *
     * @param tripMap contains all the trips that are configured and that need
     *                travel times for.
