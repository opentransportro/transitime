...
public class ArrivalDepartureGeneratorDefaultImpl
    ...
    /********************** Config Params **************************/
    private static final IntegerConfigValue maxStopsWhenNoPreviousMatch =
            new IntegerConfigValue(
                    ...
                    "If vehicle just became predictable as indicated by no " +
                            ...
                            "traverse that stop.");
    private static final IntegerConfigValue maxStopsBetweenMatches =
            new IntegerConfigValue(
    ...
    private static final IntegerConfigValue allowableDifferenceBetweenAvlTimeSecs =
     ...
     *
     * @param oldMatch The old match for the vehicle. Should be null if not previous
     *                 match
     ...
     *
     * @param vehicleState For obtaining match and AVL info
     * @param beginTime    The time of the previous AVL report or the departure time if
     ...
     *
     * @param vehicleState For obtaining match and AVL info
     * @param beginTime    Time of previous AVL report or the departure time if vehicle
     *                     was at a stop
     * @param endTime      Time of the new AVL report or the arrival time if vehicle
     *                     arrived at a stop
     */
