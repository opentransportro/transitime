...
public class AutoBlockAssigner {
    ...
    private static final BooleanConfigValue autoAssignerEnabled =
    ...
    private static final BooleanConfigValue ignoreAvlAssignments =
            new BooleanConfigValue(
    ...
    private static final DoubleConfigValue minDistanceFromCurrentReport =
    ...
    private static final IntegerConfigValue allowableLateSeconds =
            new IntegerConfigValue(
                    ...
                    "How late a vehicle can be in seconds and still be "
                            + "automatically assigned to a block");
    private static final IntegerConfigValue minTimeBetweenAutoAssigningSecs =
            new IntegerConfigValue(
    ...
    private static final HashMap<String, Long> timeVehicleLastAutoAssigned =
    ...
    private final Map<String, SpatialMatch> spatialMatchCache =
     ...
     * @param avlReport The AVL report to be matched
     * @param block     The block to match the AVL report to
     * @param useCache  true if can use match cache. The match cache is useful for
