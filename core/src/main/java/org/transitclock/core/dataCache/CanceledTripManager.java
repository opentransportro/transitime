...
public class CanceledTripManager {
    ...
    private static final LongConfigValue canceledTripCacheExpireSec =
    ...
    private final Cache<CanceledTripKey, IpcCanceledTrip> canceledTripCache;
    ...
    public boolean isCanceled(String vehicleId, String tripId) {
        ...
        return cachedTrip != null && cachedTrip.getTripId() != null &&
