...
public class PredictionDataCache {
    ...
    private static final PredictionDataCache singleton =
     ...
     *
     * @param routeIdOrShortName    route_id or route_short_name, or null to specify all routes
     *                              for stop.
     * @param directionId           Optional parameter for specifying that only want predictions
     ...
     * specified.
     *
     * @param routeStops         Specified using route_short_name or route_id, and stop_id or
     *                           stop_code
     ...
     *
     * @param newPredsForVehicleForRouteStopDest the new predictions to be set for the route/stop/destination.
     */
     ...
     *
     * @param routeShortName The route short name. Set to null to get predictions for all
     *                       routes for the stop.
     * @param stopId
     ...
     *
     * @param prediction for specifying route and stop for which to get the prediction
     *                   list for.
