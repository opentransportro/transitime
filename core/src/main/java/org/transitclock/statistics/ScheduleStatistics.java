...
public class ScheduleStatistics {
     ...
     * member.
     *
     * @param timesFromDb          data for particular trip/stop. This list will be modified by
     ...
     *
     * @param standardDeviations The number of standard of deviations to subtract from the mean
     *                           time for determining fraction of arrivals/departures that are
     *                           early.
     * @param statistics         Contains the times, the mean, and the standard deviation used
     ...
     * @param allowableDifferenceFromMeanSecs         Specifies how consistent arrival/departure times from Db must
     *                                                be in order to be used.
     * @param allowableDifferenceFromOriginalTimeSecs Specifies how consistent arrival/departure times from Db must
     *                                                be in order to be used.
     * @param desiredFractionEarly                    Specifies the desired number of the arrival times that should
     *                                                be early
     * @param arrivalsOrDepartures                    specifies whether should handle as arrivals or departures
     */
