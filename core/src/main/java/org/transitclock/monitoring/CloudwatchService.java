...
public class CloudwatchService {
    ...
    private ArrayBlockingQueue<MetricScalar> individualMetricsQueue = new ArrayBlockingQueue<MetricScalar>(100000);
    ...
    private CloudwatchService() {
        ...
        if (StringUtils.isBlank(environmentName)
            ...
            logger.warn("Cloudwatch monitoring not enabled, please specify environmentName, accessKey,"
                    + " secretKey and endpoint in configuration file");
        } else {
            logger.info(
                ...
                for (String metricName : metricMap.keySet()) {
                    ...
                    try {
                        if (metricDefinition == null
                                || metricDefinition.reportingIntervalTimeUnit == ReportingIntervalTimeUnit.IMMEDIATE)
                            continue;
