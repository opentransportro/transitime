...
public class PredictabilityMonitor extends MonitorBase {
    ...
    private static final DoubleConfigValue minPredictableBlocks =
    ...
    private static final DoubleConfigValue minPredictableBlocksGap =
            new DoubleConfigValue(
    ...
    private static final IntegerConfigValue minimumPredictableVehicles =
