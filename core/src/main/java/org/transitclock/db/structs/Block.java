...
public final class Block implements Serializable {
    ...
    private static final BooleanConfigValue blockLoading =
...
//		  + "join fetch tt.travelTimesForStopPaths tsp "
     ...
     * @param offset Use 0 for today, -Time.DAY_IN_MSECS for yesterday, and
    ...
    public boolean isActive(Date date, int allowableBeforeTimeSecs,
        ...
        if (serviceClassValidTomorrow) {
            ...
            return secsInDayBeforeMidnight > allowableStartTime
