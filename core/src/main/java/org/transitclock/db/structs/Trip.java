...
public class Trip implements Lifecycle, Serializable {
     ...
     * @param routeShortName      Needed to provide a route identifier that is consistent over
     *                            schedule changes.
     ...
     * @throws ArrayIndexOutOfBoundsException If not enough space allocated for serialized schedule times
...
//				+ ", scheduledTimesList=" + scheduledTimesList
    ...
    public boolean equals(Object obj) {
        ...
        if (tripShortName == null) {
            return other.tripShortName == null;
        } else return tripShortName.equals(other.tripShortName);
    }
