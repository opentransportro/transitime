...
public class Stop implements Serializable {
     ...
     * @param configRev
     * @param gtfsStop
     * @param stopCodeBaseValue For when stop code not specified in GTFS. If this value is set
    ...
    public boolean equals(Object obj) {
        ...
        if (name == null) {
            ...
            return false;
        if (waitStop == null) {
            return other.waitStop == null;
        } else return waitStop.equals(other.waitStop);
    }
