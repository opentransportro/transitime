...
public class DataDbLogger {
    ...
    private static final Map<String, DataDbLogger> dataDbLoggerMap =
    ...
    private final BlockingQueue<Object> queue = new LinkedBlockingQueue<Object>(QUEUE_CAPACITY);
