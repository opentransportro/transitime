...
public class GtfsStop extends CsvBase {
    ...
    /**
     * Creates a copy of the GtfsStop but updates the latitude and longitude. Useful for
    ...
    /**
     * When combining a regular stop with a supplemental stop need to create a whole new object
