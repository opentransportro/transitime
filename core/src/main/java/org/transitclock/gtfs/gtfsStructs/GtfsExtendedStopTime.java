...
public class GtfsExtendedStopTime extends GtfsStopTime {
     ...
     * @param arrivalResults   Contains statistical info including best time to use. If null
     *                         then the original schedule time is used.
     * @param departureResults Contains statistical info including best time to use. If null
     *                         then the original schedule time is used.
     */
