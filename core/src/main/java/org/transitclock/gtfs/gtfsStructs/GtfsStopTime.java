...
public class GtfsStopTime extends CsvBase implements Comparable<GtfsStopTime> {
     ...
     * @param newArrivalTime   The new arrival time. If null passed in then the original time
     *                         is used.
     * @param newDepartureTime The new departure time. If null passed in then the original
     *                         time is used.
     */
