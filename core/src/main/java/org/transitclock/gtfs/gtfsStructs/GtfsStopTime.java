...
public class GtfsStopTime extends CsvBase implements Comparable<GtfsStopTime> {
    ...
    public GtfsStopTime(
        ...
        this.arrivalTimeSecs =
                (arrivalTimeStr != null && !arrivalTimeStr.isEmpty()) ? Time.parseTimeOfDay(arrivalTimeStr) : null;
        this.departureTimeSecs = (departureTimeStr != null && !departureTimeStr.isEmpty())
    ...
    protected GtfsStopTime(GtfsStopTime originalValues, Integer newArrivalTime, Integer newDepartureTime) {
        ...
        Integer newArrivalTimeSecs = newArrivalTime != null ? newArrivalTime : originalValues.arrivalTimeSecs;
        Integer newDepartureTimeSecs = newDepartureTime != null ? newDepartureTime : originalValues.departureTimeSecs;
    ...
    public GtfsStopTime(GtfsStopTime originalStopTime, GtfsStopTime supplementStopTime) {
        ...
        this.departureTimeSecs = s.departureTimeSecs == null ? o.departureTimeSecs : s.departureTimeSecs;
        ...
        this.shapeDistTraveled = s.shapeDistTraveled == null ? o.shapeDistTraveled : s.shapeDistTraveled;
