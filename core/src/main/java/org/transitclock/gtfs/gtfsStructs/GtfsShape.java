...
public class GtfsShape extends CsvBase implements Comparable<GtfsShape> {
     ...
     */
    public GtfsShape(CSVRecord record, boolean supplemental, String fileName) throws NumberFormatException {
    ...
    /**
     * Creates a copy of the GtfsShape but updates the latitude and longitude. Useful for
     * transforming coordinates in China so that locations are properly displayed in maps.
     *
     * @param original
     * @param shapePtLat
     * @param shapePtLon
    ...
    /**
     * When combining a regular shape point with a supplemental one need to create a whole new
     * object since this class is Immutable to make it safer to use.
     *
     * @param originalShape
