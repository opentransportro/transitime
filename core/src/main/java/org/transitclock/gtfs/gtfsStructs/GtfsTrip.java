...
public class GtfsTrip extends CsvBase {
    ...
    private static final StringConfigValue tripShortNameRegEx = new StringConfigValue(
    ...
    private static final StringConfigValue blockIdRegEx = new StringConfigValue(
