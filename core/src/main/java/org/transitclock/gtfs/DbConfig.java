...
public class DbConfig {
    ...
    private final Map<String, Trip> individualTripsMap = new HashMap<String, Trip>();
    // For trips that have been read in individually. Keyed on trip short name.
    // Contains
    private final Map<String, List<Trip>> individualTripsByShortNameMap =
            new HashMap<String, List<Trip>>();
    private final StringConfigValue validateTestQuery
            = new StringConfigValue("transitclock.db.validateQuery",
            "SELECT 1",
            "query to validate database connection");
    private final BooleanConfigValue serviceIdSuffix = new BooleanConfigValue("transitclock.avl.serviceIdSuffix",
    ...
    public boolean getServiceIdSuffix() {
        return serviceIdSuffix.getValue();
    }
     ...
     *
     * @param serviceId Specified service ID that want blocks for. Can set to null to
     ...
     *
     * @param serviceId Specified which service class to look for block. If null then
    ...
    private static class ValidateSessionThread implements Runnable {
        ...
        private final DbConfig service;
