...
public class IpcPrediction implements Serializable {
     ...
     *     actualPredictionTime in that for wait stops might want to show user the scheduled time
     *     even if the actual prediction time, including the stop wait time, might be greater.
     * @param actualPredictionTime The prediction time including all factors, including the stop
     *     wait time for wait stops presented to the user is different than the actual prediction
     *     time. Only used on server side when calculating predictions.
    ...
    /**
     * Returns the short name for the route associated with the prediction. Only valid on server
     * side since uses the trip member and the trip is not passed to client.
     *
     * @return
     */
