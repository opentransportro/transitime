...
public class IpcRoute extends IpcRouteSummary {
     ...
     * @param directionId   Set if want to know which part of route is major and which is
     *                      minor. Otherwise set to null.
     * @param stopId        Set if want to know which part of route is major and which is
     *                      minor. Otherwise set to null.
     * @param tripPatternId Set if want to know which part of route is major and which is
     *                      minor. Otherwise set to null.
     */
     ...
     * @param directionId   Set if want to know which part of route is major and which is
     *                      minor. Otherwise set to null.
     * @param stopId        Used only when tripPatternId is null. In that case determines
     *                      which trip patterns are appropriate.
     * @param tripPatternId The specified trip pattern to get. If null then will use
