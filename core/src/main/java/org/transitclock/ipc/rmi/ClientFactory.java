...
public class ClientFactory<T extends Remote> {
     ...
     *     the class.
     * @return Proxy to the RMI object on the server. If there is a problem accessing the object
    ...
    public static <T extends Remote> T getInstance(String agencyId, Class<T> clazz) {
        ...
        try {
            ...
            T proxiedStub = (T) Proxy.newProxyInstance(
                    clazz.getClassLoader(), new Class<?>[] {clazz}, new RmiCallInvocationHandler(rmiStub, info));
    ...
    public static <T extends Remote> T getRmiStub(RmiStubInfo info, boolean updateHostName)
        ...
        logger.debug("Got RMI registry. Getting RMI stub from registry for " + "bindName={} ...", bindName);
