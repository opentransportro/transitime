...
public class ArchiveOldFiles extends OldFileFinder {
     ...
     * @param baseDirectory Specifies directory where to find files. This part of the
     ...
     *                      must end with a "/".
     * @param subDirectory  The subdirectory beyond the base directory. Specifies where to
     *                      find the log files to be archived. This part of the file names
     *                      is included in the file descriptions in the zip file.
     * @param daysOld       If files older than daysOld found in a directory then that
