...
public class ArchiveOldFilesModule extends Module {
    ...
    /******************** Parameters ************************************/
    private static StringConfigValue timeToArchive = new StringConfigValue(
    ...
    private static StringConfigValue awsRegion = new StringConfigValue(
            "transitclock.maintenance.awsRegion",
            AwsGlacier.OREGON_REGION,
            "The region for Amazon AWS where files should be archive " + "to.");

    private static StringConfigValue logDirForInventoryFile = new StringConfigValue(
    ...
    private static StringConfigValue logFileBaseDir = new StringConfigValue(
    ...
    private static StringConfigValue awsVaultName = new StringConfigValue(
    ...
    private static StringConfigValue awsVaultName2 = new StringConfigValue(
    ...
    private static StringConfigValue logFileSubDirectory = new StringConfigValue(
    ...
    private static StringConfigValue logFileSubDirectory2 = new StringConfigValue(
    ...
    private static IntegerConfigValue daysTillFilesArchived = new IntegerConfigValue(
            "transitclock.maintenance.daysTillFilesArchived",
            90,
            "How many days old files can be online before they are archived.");

    private static IntegerConfigValue daysTillFilesArchived2 = new IntegerConfigValue(
    ...
    private void archiveLogFiles() {
        ...
        ArchiveOldFiles.archive(
                archiver, logFileBaseDir.getValue(), logFileSubDirectory.getValue(), daysTillFilesArchived.getValue());
