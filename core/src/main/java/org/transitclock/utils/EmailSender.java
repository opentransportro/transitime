...
public class EmailSender {
    ...
    /********************** Parameters ********************************/
    private static StringConfigValue emailConfigFile = new StringConfigValue(
    ...
    private static synchronized Properties getProperties() {
        ...
        try (InputStream input = Files.newInputStream(path)) {
            ...
            logger.error("Cannot open and load e-mail server properties " + "file \"{}\".", emailConfigFile.getValue());
        }
