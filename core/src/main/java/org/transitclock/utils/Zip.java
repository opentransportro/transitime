...
public class Zip {
     ...
     * @param subDirectory If not null then will put the resulting unzipped files into
     ...
     * @param inputFileNames  List of files to be put into the zip file. File names should
     ...
     * fileNames.
     *
     * @param inputDirectory Where to find the files. This part of the name is not included
     *                       as part of the file names in the zip file.
     * @param fileOrDirName  Name, relative to the inputDirectory, of file or directory to
     *                       be added to the fileNames array.
     * @param fileNames      The resulting list of file names.
     * @param outputFileName Name of resulting zip file. The file will be put into the
     ...
     * file.
     *
     * @param inputDirectory The name of the directory where to start. This name is not
     *                       included in the file names in the zip file
     * @param subDirectory   Appended to inputDirectory to specify what directory to be
