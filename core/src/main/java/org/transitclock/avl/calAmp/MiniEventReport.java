...
public class MiniEventReport extends Report {
    ...
    public void process() {
        if (isValidGps()) {
            ...
            AvlReport avlReport =
                    new AvlReport(vehicleId, getEpochTime(), getLat(), getLon(), getSpeed(), getHeading(), "CalAmp");
            ...
            logger.error(
                    "GPS fix mini event report is not valid. Fix status " + "is \"{}\". {}", getFixStatusStr(), this);
        }
    }
}
