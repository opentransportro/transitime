...
public class TaipGpsLocation {
    ...
    private static boolean validate(String s) {
        ...
        if (s.length() < 35) {
            logger.warn("TAIP string \"{}\" isn't for RPV command since " + "less than 35 characters long", s);
            return false;
        }
    ...
    public static TaipGpsLocation get(String s) {
        ...
        // get it right.
        long fixEpochTime = Time.getStartOfDay(new Date(), gmtTimeZone) + secondsIntoDay * Time.MS_PER_SEC;
