...
public class ZonarAvlModule extends XmlPollingAvlModule {
    ...
    private static final StringConfigValue zonarAccount =
    ...
    private static final StringConfigValue zonarUserName =
            new StringConfigValue("transitclock.avl.zonarUserName",
                    "The Zonar user name for API calls.");

    private static final StringConfigValue zonarPassword =
