...
public class WorkwaveAvlModule extends PollUrlAvlModule {
    ...
    /**
     * Access the page GET_SESSION_URL to get the cookie PHPSESSID and stores the resulting cookie
     * in sessionId member. Then when getting AVL data can send the PHPSESSID cookie as
     * authentication.
     */
    ...
    protected Collection<AvlReport> processData(InputStream in) throws Exception {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); ++i) {
                ...
                // Process AVL report
                AvlReport avlReport =
                        new AvlReport(vehicleId, gpsTime.getTime(), latitude, longitude, speed, heading, "WorkWave");
