...
public class DbAvlReader extends Module {
    ...
    private static final StringConfigValue dbUrl =
            new StringConfigValue("transitclock.avl.dbUrl", null, "The jdbc url of the avl database");
    private static final StringConfigValue dbQuery =
    ...
    private static final StringConfigValue validationQuery =
    ...
    private static final IntegerConfigValue pollingRateMsec =
