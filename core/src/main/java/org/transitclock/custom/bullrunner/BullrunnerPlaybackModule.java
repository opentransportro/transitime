...
public class BullrunnerPlaybackModule extends PollUrlAvlModule {
    ...
    private static StringConfigValue bullrunnerbasePlaybackUrl = new StringConfigValue(
    ...
    private static StringConfigValue playbackStartTimeStr = new StringConfigValue(
            "transitclock.avl.bullrunner.playbackStartTime",
            "08-06-2018 12:00:00",
            "Date and time of when to start the playback.");

    private static StringConfigValue playbackEndTimeStr = new StringConfigValue(
