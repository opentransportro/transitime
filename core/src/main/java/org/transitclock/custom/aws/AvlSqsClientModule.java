...
public class AvlSqsClientModule extends Module {
    ...
    private static final IntegerConfigValue avlQueueSize =
    ...
    private static final IntegerConfigValue numAvlThreads =
    ...
    private static final IntegerConfigValue jmsPauseTimeInSeconds =
            new IntegerConfigValue("transitclock.avl.jmsPauseTimeInSeconds", 20,
                    "How long to block for the next message.");
    private static final IntegerConfigValue messageLogFrequency =
    ...
    private static final StringConfigValue applicableList =
    ...
    private final AWSCredentials _sqsCredentials;
    private final SqsMessageUnmarshaller _messageUnmarshaller;
    private final ArrayBlockingQueue<Message> _receiveQueue;
    private final ArrayBlockingQueue<Message> _deserializeQueue;
    private final ArrayBlockingQueue<Message> _acknowledgeQueue;
    private final ArrayBlockingQueue<Message> _archiveQueue;
    private final CloudwatchService monitoring;
