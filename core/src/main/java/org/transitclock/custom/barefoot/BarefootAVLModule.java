...
public class BarefootAVLModule extends PollUrlAvlModule {
    ...
    private static final IntegerConfigValue barefootPort = new IntegerConfigValue("transitclock.avl.barefoot.subscribe.port",
            1235, "This is the port of the barefoot server to subscribe to.");

    private static final StringConfigValue barefootServer = new StringConfigValue(
            "transitclock.avl.barefoot.subscribe.server", "127.0.0.1",
            "This is the server that is running the barefoot map matching service.");

    private static final DoubleConfigValue minProbability = new DoubleConfigValue(
    ...
    private static final HashMap<String, Point> locations = new HashMap<String, Point>();
