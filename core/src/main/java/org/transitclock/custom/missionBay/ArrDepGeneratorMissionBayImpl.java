...
public class ArrDepGeneratorMissionBayImpl extends ArrivalDepartureGeneratorDefaultImpl {
    ...
    protected Arrival createArrivalTime(
        ...
        Arrival arrival = super.createArrivalTime(vehicleState, arrivalTime, block, tripIndex, stopPathIndex);
    ...
    /**
     * Calls the superclass createDepartureTime() but for SFMTA stops also writes both the arrival
     * and the departure time for that stop can be written to the SFMTA API.
     */
    protected Departure createDepartureTime(
        ...
        Departure departure = super.createDepartureTime(vehicleState, departureTime, block, tripIndex, stopPathIndex);
        ...
        if (sfmtaStopMap.containsKey(departure.getStopId())) {
            ...
            for (Arrival arrival : arrivals) {
                if (arrival.getVehicleId().equals(departure.getVehicleId())
                    ...
                    logger.info("Found arrival/departure pair for SFMTA stop. " + "{} {} ", arrival, departure);
