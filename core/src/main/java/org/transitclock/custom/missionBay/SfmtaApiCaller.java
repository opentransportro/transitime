...
public class SfmtaApiCaller {
    ...
    private static final StringConfigValue telemetryUrl =
    ...
    private static final IntegerConfigValue avlReportsBatchSize =
    ...
    private static final List<AvlReport> avlReports = new ArrayList<AvlReport>();
...
//			sb.append("      \"StopLocationLongitude\": " + 0.0 + ",\n");
    ...
    private static class VInfo {
        private final String vehiclePlacardNum;
