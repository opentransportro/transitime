...
public class MissionBayConfig {
    ...
    public static List<Dir> getSpecialCaseDirections(String routeId) {
        ...
        if (routeId.equals("east")) {
            ...
            d1.gtfsDirection = "0";
            String stops1[] = {
                "1650owen", "berr5th_s", "chinb185", "calcream", "powell", "calttown", "berr5th_n", "1650owen"
            };
            d1.stopIds = Arrays.asList(stops1);
            dirList.add(d1);
            ...
            d1.gtfsDirection = "0";
            String stops1[] = {
                "1650owen", "berr5th_s", "calcream", "powell", "calttown", "library", "nektar", "409illi_e", "1650owen"
            };
            d1.stopIds = Arrays.asList(stops1);
            dirList.add(d1);
            ...
            d1.gtfsDirection = "0";
            String stops1[] = {"1650owen", "calttown", "library", "chinbas", "nektar", "409illi_e", "1650owen"};
            d1.stopIds = Arrays.asList(stops1);
            dirList.add(d1);
            ...
            d3.gtfsDirection = "0";
            String stops3[] = {"nektar", "409illi_e", "1650owen", "calttown", "library", "chinbas", "nektar"};
     ...
     * preferred to automatically determine the paths for each trip pattern using only the NextBus
     * API but the naming conventions were far too haphazard. Only way to really make it work is to
     * list the path IDs here manually by looking at data in (for route west for example)
     ...
     * trip pattern defined in the above method getSpecialCaseDirections() you need to include all
     * the paths between the stops, including the "_d" departure paths, to get the full shape.
     *
    ...
    public static Map<String, List<String>> getPathData() {
        ...
        List<String> pathIds_caltrain_am_transbay_loop = Arrays.asList(pathIds_array_caltrain_am_transbay_loop);
        ...
        List<String> pathIds_caltrain_pm_transbay_loop = Arrays.asList(pathIds_array_caltrain_pm_transbay_loop);
