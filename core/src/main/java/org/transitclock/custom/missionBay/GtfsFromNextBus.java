...
import org.transitclock.gtfs.writers.*;
...
public class GtfsFromNextBus {
    ...
    private static final StringListConfigValue validBlockIds =
    ...
    private static final Map<String, GtfsStop> gtfsStopsMap =
     ...
     * @param routeId
     * @param tripStartTimeStr      Needed so can differentiate between morning and afternoon
...
//				}
     ...
     * @param routeId
     * @param beginIndex        So can determine first stop of this trip so can determine when
     *                          wrap around
...
//		}
        ...
        return stopTimesForBlock.get(i).stopTime >
