...
public class MbtaPredictionAccuracyModule extends PredictionAccuracyModule {
    ...
    private static final StringConfigValue apiKey = new StringConfigValue(
    ...
    private String getUrl(String routeId) {
        return getExternalPredictionApiUrl() + "api_key=" + getApiKey() + "&format=xml" + "&route=" + routeId;
    }
    ...
    private Document getExternalPredictionsForRoute(RouteAndStops routeAndStops) {
        ...
        logger.info("Getting predictions from API for route={} using URL={}", routeAndStops.routeId, fullUrl);
     ...
     * arrival prediction (wait stops are terminal departures and are therefore departure
     * predictions.
     *
     * @param tripId
     * @param stopId
