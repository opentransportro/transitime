...
public class GenerateMbtaBlockInfo {
    ...
    // with the trip.
    private static Map<String, Set<String>> mismatchedAssignments = new HashMap<String, Set<String>>();
    ...
    private static void writeSupplementalTripsFile(String supplementTripsFileName) {
        ...
        for (String tripShortName : sortedTripNames) {
            ...
            GtfsTrip supplementGtfsTrip = new GtfsTrip(
                    null, serviceIdForTrip, null, null, tripShortName, null, blockIdForTrip, null, null, null);
     ...
     * means that some early data had the wrong trip identifier. To make this class work with the
     * old problematic names stored in the AVL database need to adjust them to remove the trailing
     * zeros.
     *
     * @param assignment
    ...
    /**
     * Processes days worth of AVL data to determine the block assignments for each trip. Updates
     * the static tripToBlockMap with the block assignment for each trip.
     *
     * @param beginDate
     */
    private static void processDayOfData(Date beginDate) {
        ...
        List<AvlReport> avlReports = AvlReport.getAvlReportsFromDb(beginDate, endDate, null, "ORDER BY time");
        ...
        Map<String, List<AvlReport>> reportsByVehicle = new HashMap<String, List<AvlReport>>(avlReports.size());
        ...
        for (String vehicleId : reportsByVehicle.keySet()) {
            ...
            for (AvlReport avlReport : avlReportsForVehicle) {
                ...
                if (tripShortName.equals(previousTripShortName) && blockId.equals(previousBlockId)) continue;
                ...
                if (earlinessOfAssignment < 15 * Time.SEC_PER_MIN && !previousBlockId.equals("000")) continue;
