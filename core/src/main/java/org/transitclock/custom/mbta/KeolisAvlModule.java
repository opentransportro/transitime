...
public class KeolisAvlModule extends PollUrlAvlModule {
    ...
    private static StringConfigValue mbtaCommuterRailFeedUrl =
            new StringConfigValue("transitclock.avl.mbtaCommuterRailFeedUrl", "The URL of the Keolis feed to use.");

    private static IntegerConfigValue keolisFeedAvlTimeOffset = new IntegerConfigValue(
    ...
    protected Collection<AvlReport> processData(InputStream in) throws Exception {
        ...
        try {
            ...
            for (String tripName : tripNames) {
                ...
                // specify the offset.
                long gpsTime = v.getLong("vehicle_timestamp") * Time.MS_PER_SEC
