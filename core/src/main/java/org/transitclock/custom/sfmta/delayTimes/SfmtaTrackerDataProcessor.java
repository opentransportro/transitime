...
public class SfmtaTrackerDataProcessor {
    ...
    // be stopped.
    private static final double MIN_RADIUS_FROM_INTERSECTION = 35.0; // FIXME changed to 15 to get Shrader data // 35.0;
     ...
     * @return
     */
    private static TopSpeedLoc topSpeed(List<Loc> locs, Location intersectionLoc, double minRadiusFromIntersection) {
        ...
        for (int i = 1; i < locs.size() - 2; ++i) {
            ...
            double distance = Geo.distance(new Location(loc1.lat, loc1.lon), new Location(loc2.lat, loc2.lon));
    ...
    private static void processIntersectionMatch(
        ...
        TopSpeedLoc v1TopSpeedLoc = topSpeed(matchesToV1, intersectionLoc, MIN_RADIUS_FROM_INTERSECTION);
        ...
        TopSpeedLoc v2TopSpeedLoc = topSpeed(matchesToV2, intersectionLoc, MIN_RADIUS_FROM_INTERSECTION);
        ...
        double distanceBetweenLocs = Geo.distanceHaversine(v1TopSpeedLoc.getLocation(), v2TopSpeedLoc.getLocation());
