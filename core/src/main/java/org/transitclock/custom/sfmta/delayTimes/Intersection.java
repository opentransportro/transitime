...
public class Intersection {
    ...
    /**
     * Returns distance from lat,lon to the first path segment. Returns NaN if the match is to
     * before or after the vector or if the distance from the vector is greater than
     * allowableDistance.
     *
     * @param loc
     * @return
    ...
    /**
     * Returns distance from lat,lon to the second path segment. Returns NaN if the match is to
     * before or after the vector or if the distance from the vector is greater than
     * allowableDistance.
     *
     * @param loc
