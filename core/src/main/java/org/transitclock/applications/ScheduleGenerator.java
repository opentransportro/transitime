...
//
//        options.addOption("updateFirstStopOfTrip", false, "Set if should modify time even for first stops of trips.");
//
//        // Parse the options
...
//            } catch (NumberFormatException e) {
//                System.err.println(
//                        "Option -allowableFromOriginal value \"" + param + "\" could not be parsed into an integer.");
//                System.exit(-1);
//            }
//        }
//
...
//        ScheduleDataProcessor stats = new ScheduleDataProcessor(
//                gtfsDirectoryName,
//                beginTime,
//                endTime,
