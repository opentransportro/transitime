...
public class GtfsFileProcessor {
     ...
     * @param configRev                         If not -1 then will use this config rev instead of
     *                                          incrementing from the current config rev from the db
     * @param shouldStoreNewRevs                If true then will store the new config and travel times revs
