...
public class ConvertGtfsRtToCsvFile {
    ...
    private static StringConfigValue csvFileOutputDir = new StringConfigValue(
    ...
    private static StringConfigValue timeZoneStr = new StringConfigValue(
            "transitclock.avl.timeZoneStr", "", "The timezone for the agency. In the form " + "\"America/New_York\"");

    private static boolean shouldOffsetForMapOfChina() {
        return offsetForMapOfChina.getValue();
    }

    private static BooleanConfigValue offsetForMapOfChina = new BooleanConfigValue(
     ...
     */
    private static void processReport(AvlReport avlReport, Map<String, List<AvlReport>> avlReportsByVehicle) {
