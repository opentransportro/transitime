...
public class RmiQuery {
    ...
    private static void getPredictions() throws RemoteException {
        // just for debugging
        System.err.println("Getting predictions for agencyId="
                + agencyId
                + " lat="
                + latitude
                + " lon="
        ...
        if (!Double.isNaN(latitude) && !Double.isNaN(longitude)) {
            ...
            System.out.println(
                    "Predictions for agencyId=" + agencyId + " routeId=" + routeId + " stopId=" + stopId + " are:");
            for (IpcPredictionsForRouteStopDest preds : predictionList) {
                System.out.println("  " + preds);
            }
        } else {
            ...
            System.out.println("Predictions for agencyId=" + agencyId + " routeStops=" + routeStops + " are:\n");
    ...
    private static void getVehicles() throws RemoteException {
        // just for debugging
        System.err.println("Getting vehicles for agencyId="
                + agencyId
                + " routeShortNames="
                + routeShortNames
                + " vehicleIds="
