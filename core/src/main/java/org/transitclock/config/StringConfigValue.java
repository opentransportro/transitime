...
public class StringConfigValue extends ConfigValue<String> {
     ...
     *
     * @param id
     * @param defaultValue Default value, but can be set to null for if null is a
     *                     reasonable default.
     * @param description
     */
     ...
     * @param defaultValue
     * @param description
     * @param okToLogValue If false then won't log value in log file. This is useful for
     *                     passwords and such.
     */
    public StringConfigValue(String id, String defaultValue,
