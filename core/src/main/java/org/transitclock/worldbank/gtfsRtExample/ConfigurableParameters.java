...
public class ConfigurableParameters {
    ...
    // proper order.
    public static final String DATABASE_QUERY = "SELECT vehicleid AS vehicle_id, \n"
    ...
    public static final String DATABASE_POLLING_QUERY = "SELECT vehicleid AS vehicle_id, \n"
            + "null AS license_plate, \n"
