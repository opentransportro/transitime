...
<div id="map">
    <div class="modal">
        ...
        <div style="display: flex; margin-top: 10px;">
            <div class="circle_early"></div>
            - <fmt:message key="Early"/></div>
        <div style="display: flex; margin-top: 10px;">
            <div class="circle_ontime"></div>
            - <fmt:message key="OnTime"/></div>
        <div style="display: flex; margin-top: 10px;">
            <div class="circle_late"></div>
            - <fmt:message key="Later"/></div>
        <div style="display: flex; margin-top: 10px;">
            <div class="bus"></div>
            - <fmt:message key="NoInformation"/></div>
        <div style="margin-top: 10px;"></div>
        <input type="checkbox" id="showOnlyPredictedVehicles" name="showOnlyPredictedVehicles"
               value="showOnlyPredictedVehicles" onclick="onClickShowOnlyPredictedVehicles()">
