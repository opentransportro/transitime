...
public class TransitimeApi {
     ...
     *
     * @param stdParameters        StdParametersBean that gets the standard parameters from the
     ...
     * @param stopId               Optional way of specifying a stop so can get predictions for
     ...
     * @param numberPredictions    For when determining which vehicles are generating the
     ...
     * @param stdParameters     StdParametersBean that gets the standard parameters from the
     *                          URI, query string, and headers.
     * @param routeStopStrs     List of route/stops to return predictions for. If route not
     ...
     * @param stopStrs          List of stops to return predictions for. Provides predictions
     ...
     * @param maxDistance       How far away a stop can be from the lat/lon. Default is 1,500
     *                          m.
     * @param numberPredictions Maximum number of predictions to return. Default value is 3.
     * @return
     * @throws WebApplicationException
     ...
     * @param stopId               optional. If set then only this stop and the remaining ones on
     ...
     * @param direction            optional. If set then only the shape for specified direction
     ...
     * @param tripPatternId        optional. If set then only the specified trip pattern is
