...
public class AvlJsonQuery {
     ...
     *
     * @param agencyId
     * @param vehicleId Which vehicle to get data for. Set to null or empty string to
...
//need to limit the vehicle state table by time as well to utilize index on avlTime column
     ...
     *
     * @param agencyId
     * @param vehicleId Which vehicle to get data for. Set to empty string to get data
     *                  for all vehicles. If null then will get data by route.
     * @param routeId   Which route to get data for. Set to empty string to get data
