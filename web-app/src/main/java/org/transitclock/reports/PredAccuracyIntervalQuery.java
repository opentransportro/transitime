...
public class PredAccuracyIntervalQuery extends PredictionAccuracyQuery {
     ...
     * @param percentage The percentage (0.0 - 100.0%) of prediction accuracy data that
     ...
     *
     * @param builder
     * @param intervalsType       Specifies whether should output for intervals standard
     ...
     *                            data for entire day.
     * @param endTimeStr          For specifying time of day between the begin and end date to
     *                            use data for. Can thereby specify a date range of a week but
     *                            then just look at data for particular time of day, such as 7am
     *                            to 9am, for those days. Set to null or empty string to use
     *                            data for entire day.
