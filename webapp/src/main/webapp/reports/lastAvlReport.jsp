...
<table id="dataTable">
    <tr>
        <th><fmt:message key="div.Vehicle"/></th>
        <th><fmt:message key="div.lgps"/></th>
        <th><fmt:message key="div.lat"/></th>
        <th>
        <fmt:message key="div.lon"/>
        <th><fmt:message key="PositionOnMap"/></th>
    </tr>
</table>
</body>
</html>