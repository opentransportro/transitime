...
public class StringUtils {
     ...
     * numbers have the same number of digits. This way can sort the names properly even if have
     * names such as Y2 and Y101 (Y2 should be before Y101 even though if used regular string
     * comparison Y101 would be before Y2).
     *
     * @param name The alpha numeric name to be padded.
     * @return a modified version of the name that can be used for proper ordering of a collection
     *     of names. for ordering
     */
    ...
    /**
     * Sorts the list of IDs. Pads the first numeric part of the identifiers when doing the sorting
     * so that numbers will end up in the proper order. This is 10 times slower than sortIds(), but
     * the ordering is much nicer.
     *
     * @param ids
     */
