...
public class TransitimeQuickStart implements Runnable {
    ...
    public void startGtfsFileProcessor(String gtfsZipFileName) throws QuickStartException {
        /**
         * called from input panel Start GtfsFileProcessor using the gtfs file selected from the
         * input panel
         */
        try {
    ...
    public void startCore(String realtimefeedURL, String loglocation) throws QuickStartException {
        /**
         * Starts the main core of transitime using the entered realtime feed or default if nothing
         * is entered, feed must be entered correctly as it will only use default if nothing has
         * been passed through for the realtimefeedUrl, if nothing is entered for the loglocation
         * will use where the transitimeQuickStart was called
         */
        try {
            ConfigFileReader.processConfig();
